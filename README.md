...
## Funções  
Íris possui alguns comandos, você pode checar [Este Local](https://github.com/KillovSky/Iris/tree/main/lib/Commands) para obter a lista e ter uma ideia melhor.  
...
2. - [NodeJS](https://nodejs.org) - Interface de programação da Íris, use a LTS e não esqueça de ativar a instalação da [Build Tools](https://github.com/KillovSky/iris/issues/538).  
...
Se `apt-get` também não funcionar, você pode precisar compilar `apt` no seu sistema, apenas [Verifique Isto - 'Usuários Avançados'](https://askubuntu.com/questions/860375/installing-apt-get), tente compilar manualmente ou mude a sua Distro, [aqui](https://github.com/KillovSky/Iris/discussions/28) estão algumas recomendações.  
  
## Instalação  
Para baixar a Íris - [Após ter os requisitos] - dê uma olhada [Neste Tutorial](https://github.com/KillovSky/iris/discussions/28) ou [Aqui](http://htmlpreview.github.io/?https://github.com/KillovSky/iris/blob/main/.readme/donates/page.html). (Desatualizados, para baixar a Íris deles [Clique Aqui](https://github.com/KillovSky/Iris/tree/OpenWA))  
...
Antes de fazer a inicialização, você precisa configurar todos os parâmetros não opcionais descritos [Aqui](https://github.com/KillovSky/iris/blob/main/.readme/pt/config.md), caso contrario, muitos comandos não vão funcionar.  
