...
const partners = [
    ...
    {
        name: "SLIME NEWS",
        description: "Seu portal mágico para notícias, novidades e encantos de animes, games, mangás, manhwa e mais.",
        url: "https://slimenews.fun/",
        image: "images/slimenews.png",
        added: "2024-11-01",
        type: "Website",
    },
    {
...
function toggleDescription(index, isList = false) {
    ...
    const truncatedDescription = isList ? fullDescription.substring(0, 30) : fullDescription.substring(0, 60);
...
function sortByColumn(column, ascending) {
    ...
    partners.sort((a, b) => ascending ? sortFunctions[column](a, b) : sortFunctions[column](b, a));
