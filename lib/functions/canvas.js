...
exports.bolso1 = async (canvaimage) => {
	...
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/bolsonaro/template.png')
...
exports.bolso2 = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/bolso_frame/template.png')
...
exports.bolso3 = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/bolsonaro2/template.png')
	let frame = await canvas.loadImage(canvaimage)
	let bolsoCanvas = canvas.createCanvas(bg.width, bg.height)
	let ctx = bolsoCanvas.getContext("2d")
...
exports.sponge = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/bob_burning_paper/template.png')
	let frame = await canvas.loadImage(canvaimage)
...
exports.briggs = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/briggs_cover/template.png')
	let frame = await canvas.loadImage(canvaimage)
...
exports.ednaldoBandeira = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/ednaldo_bandeira/template.png')
	let frame = await canvas.loadImage(canvaimage)
...
exports.ednaldoTV = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/ednaldo_tv/template.png')
	let frame = await canvas.loadImage(canvaimage)
...
exports.markSuckerberg = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/mark_meta/template.png')
	let frame = await canvas.loadImage(canvaimage)
...
exports.paper = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/passing_paper/template.png')
	let frame = await canvas.loadImage(canvaimage)
...
exports.pepe = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/pepe_dream/template.png')
	let frame = await canvas.loadImage(canvaimage)
...
exports.shotTV = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/rip_tv/rip_tv_og.png')
	let frame = await canvas.loadImage(canvaimage)
...
exports.romero = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage('https://raw.githubusercontent.com/LorittaBot/GabrielaImageGenAssets/main/image_templates/romero_britto/template.png')
	let frame = await canvas.loadImage(canvaimage)
