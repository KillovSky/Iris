...
module.exports = shop = async (kill, message, args, user, file) => {
	...
	switch (args[0]) {
		...
		case '1':
			...
			tools('gaming').addValue(user, -100, file, 'coin')
			break
		...
		case '3':
			...
			tools('gaming').addValue(user, -5000, file, 'coin')
			break
		...
		case '6':
			...
			tools('gaming').addValue(user, -500, file, 'coin')
			break
		...
		case '7':
			...
			tools('gaming').addValue(user, -2500, file, 'coin')
			break
		...
		case '9':
			...
			if (sorted == 'xp' || sorted == 'coin' || sorted == 'rubi' || sorted == 'dima') {
				tools('gaming').addValue(user, 250, file, sorted)
		...
		case '10':
			...
			tools('gaming').addValue(user, -150, file, 'coin')
			break
		...
		case '11':
			...
			tools('gaming').addValue(sender.id, Number(shop.Diamonds_Pack), file, 'xp')
			...
			tools('gaming').addValue(user, -400, file, 'coin')
			break
		...
		case '14':
			...
			tools('gaming').addValue(sender.id, Number(shop.Diamond_Change), file, 'coin')
			...
			tools('gaming').addValue(user, -180, file, 'coin')
			break
