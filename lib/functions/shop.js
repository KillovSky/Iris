...
module.exports = shop = async (kill, message, args, user, file, chatId) => {
	...
	switch (args[0]) {
		...
		case '1':
			...
			tools('gaming').addValue(user, Number(-config.Guild_Rate_Price), file, 'coin')
			break
		...
		case '2':
			...
			tools('gaming').addValue(user, Number(-config.Stop_Loss_Price), file, 'coin')
			break
		...
		case '3':
			...
			tools('gaming').addValue(user, Number(-config.Lose_All_Price), file, 'coin')
			break
		...
		case '4':
			...
			tools('gaming').addValue(user, Number(-config.Lose_Rate_Price), file, 'coin')
			break
		...
		case '5':
			...
			tools('gaming').addValue(user, Number(-config.Win_Rate_Price), file, 'coin')
			break
		...
		case '6':
			...
			tools('gaming').addValue(user, Number(-config.Mine_Price), file, 'coin')
			break
		...
		case '7':
			...
			tools('gaming').addValue(user, Number(-config.Vip_Price), file, 'coin')
			break
		...
		case '8':
			...
			tools('gaming').addValue(user, Number(-config.NOBG_Value), file, 'coin')
			break
		...
		case '9':
			...
			tools('gaming').addValue(user, Number(-config.Surprise_Price), file, 'coin')
			break
		...
		case '10':
			...
			tools('gaming').addValue(user, Number(-config.XP_Pack_Price), file, 'coin')
		...
		case '11':
			...
			tools('gaming').addValue(user, Number(-config.Diamonds_Pack_Price), file, 'coin')
		...
		case '12':
			...
			tools('gaming').addValue(user, Number(-config.Rubi_Pack_Price), file, 'coin')
		...
		case '13':
			...
			tools('gaming').addValue(user, Number(config.Rubi_Change_Win), file, 'coin')
		...
		case '14':
			...
			tools('gaming').addValue(user, Number(config.Diamond_Change_Win), file, 'coin')
