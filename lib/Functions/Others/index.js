...
function getPatent(
    ...
    /* Define o nível */
    const leveler = typeof level === 'string' || typeof level === 'number' ? level : 500;

    /* Try-Catch para casos de erro */
    try {
        /* Se recebeu tudo corretamente, se der ruim, não fará nada */
        if (/[0-9]+/gi.test(leveler) && typeof patentes === 'object') {
    ...
    Object.keys(obj).some((prop) => {
        ...
        if (!keyInObject) {
            ...
            if (typeof obj[prop] === 'object') {
                ...
                /* Se não for, mas incluir a propriedade */
            } else if (keys.includes(prop) && types.includes(typeof obj[prop])) {
                /* Se não for um objeto e a chave e tipo desejados, retorna o valor da chave */
