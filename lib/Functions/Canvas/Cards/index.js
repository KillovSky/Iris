...
async function chessCard(
    ...
    /* Define o FEN */
    let fenMoves = envInfo.functions.chess.arguments.fenData.value;
    fenMoves = typeof fenData === 'string' ? (validateFEN(fenData).ok === true ? fenData : fenMoves) : fenMoves;
...
async function tttCard(
    ...
    /* Try-Catch para casos de erro */
    try {
        /* Verifica se o board é uma Object */
