...
const databaseSQL = path.normalize(`${process.cwd()}/lib/Databases/Informations/Users.db`);
...
function executeSQLite(file, typecode, user, chatId, keyup, limit, value) {
    /* Determina se vai rodar */
    if ([file, typecode, user, chatId, keyup, limit, value].some((s) => s !== null)) {
...
function validateJSON(stringJSON) {
    ...
    if (['string', 'object', 'array'].includes(typeof stringJSON) && stringJSON != null) {
        ...
        try {
            ...
            if (typeof stringJSON === 'string') {
                ...
                inputJSON = inputJSON.replace(/(['"])?([a-zA-Z0-9_]+)(['"])?:/g, '"$2": ').replace(/'/g, '"');
...
function updateValues(
    ...
    try {
        ...
        const conditions = (
            ...
            && /@c.us|false|null/gi.test(user)

            /* Caso o chatId contenha uso correto */
            && /@g.us|false|null/gi.test(chatId)
        );
...
function getValues(
    ...
    try {
        ...
        const conditions = (
            ...
            /* Caso o chatId contenha uso correto */
            && /@g.us|false|null|getall/gi.test(chatId)
        );
        ...
        if (conditions === true) {
            ...
            /* Executa o comando */
            executeSQLite(file, funUsage, user, chatId, null, null, null);
...
function undoValues(
    ...
    /* Define o valor final como o padrão */
    ambientEnv.value = envInfo.parameters.standard.value[file] || {};
...
function rankingValues(
    ...
    try {
        ...
        if (conditions === true) {
            ...
            /* Executa o comando */
            executeSQLite(file, 'sort', null, newchatId, keysort, limit, null);
