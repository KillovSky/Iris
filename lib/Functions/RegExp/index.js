...
function isURL(
    ...
    try {
        ...
        if (typeof linkText === 'string') {
            /* Define a RegExp */
            const linkexpRegExp = createRegExp(envInfo.parameters.linkexp.value);

            /* Verifica se é uma URL usando a RegExp e instanceof URL */
            envInfo.results.value = {
                isURL: linkexpRegExp.test(linkText) || linkText instanceof URL,
                matchedURL: (linkText.match(linkexpRegExp) || ['none'])[0],
            };
        }
