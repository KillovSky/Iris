...
/* JSON */
const envInfo = JSON.parse(fs.readFileSync(`${thisDirname}/utils.json`));
...
function generateHEX(
    ...
    try {
        ...
        if (isAnotherFun === false) {
            ...
            logging.echoError(error, envInfo, thisDirname);
...
function printConsole(
    ...
    let printerText = `\x1b[31m[${path.basename(thisDirname)}]\x1B[39m → \x1b[33mThe operation cannot be completed because no text has been sent.\x1B[39m`;
...
function reportConsole(
    ...
    envInfo.results.value = `\x1b[31m[${path.basename(thisDirname)}]\x1B[39m → \x1b[33mThe operation cannot be completed because no text has been sent.\x1B[39m`;
 ...
 * @param {string} [dirname=thisDirname] - Caminho do diretório atual
...
const resetLocal = (
    ...
    functions: {
        ...
        [envInfo.exports.messedup]: { value: global.logging.echoError },
        [envInfo.exports.poswork]: { value: global.logging.postResults },
