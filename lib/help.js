...
_ℹ️ - Se você gostou de mim, considere olhar meu grupo oficial!_ */Legião*
...
*6 - /criador*
_Conheça o carinho legal que me construiu, se quiser saber mais dele use /dono._
...
*20 - /comandos*
_Aqui estão meus outros comandos, mas são mais lentos. [Legião-Z apenas em!]
...
*44 - /Char*
_Ao usar esse comando eu te envio um personagem de anime aleatorio e sua biografia._
...
*48 - /goat*
_Bodes. Preciso dizer algo a mais?_
...
*92 - /gaming <nome>*
_Crie logos de jogador._ (em manutencao)
...
exports.down = down() // Estão inutilizaveis, estarei tentando achar formas
function down() {
    return `
	*☾ Downloads ☽*
...
Caso não entenda, chame o Lucas R. - KillovSky ou use o comando /criador, ou pergunte no grupo que alguém com certeza te ajudará! XD
...
function donate() {
    return `
 Agradecemos muito pelo suporte, de antemão, doações não são necessarias, basta que você cuide bem da Íris ou auxilie os usuarios, se você deseja ver ela ficar melhor mais rapidamente, você pode contribuir com qualquer quantia de dinheiro, que é usado para criar comandos que são pagos e a manter o PC/Telefone atualizado, e algum dia obter um servidor._
Caso você queira contibuir, nosso picpay é @userlucas123, caso não tenha mas ainda queira ajudar, fale com a pessoa abaixo. ;D ❤️`
}
