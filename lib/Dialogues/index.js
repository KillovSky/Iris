...
function dialoguePicker(
    ...
    try {
        ...
        if (regionPicker === 'G.A.L') {
            ...
            const tempLanguages = JSON.parse(fs.readFileSync(`${thisDir}/Default/index.json`));
        ...
        const dialFolder = fs.readdirSync(thisDir);
        ...
        let allDial = JSON.parse(fs.readFileSync(`${thisDir}/${dialType}/index.json`));
        ...
        if (!allKeys.includes(dialName)) {
            ...
            if (allKeys.includes(dnamer)) {
                ...
                /* Define o padrão */
                allDial = (JSON.parse(fs.readFileSync(`${thisDir}/Default/index.json`)));
        ...
        /* Retorna o padrão */
        return JSON.parse(fs.readFileSync(`${thisDir}/Default/index.json`)).pt.Default;
    }
}
