...
const ss = async(query) => { // Um print de site
    request({
        ...
        encoding: "binary",
        qs: {
            access_key: "https://api.apiflash.com/v1/urltoimage?access_key=2b3b68eaf6e74560bfdf7428ad9a5623&url=http://google.com", // Insira uma api do site apiflash url to image dentro das aspas
            url: query
        }
    }, (error, response, body) => {
        if (error) {
