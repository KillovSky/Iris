        ...
        if (typeof kill === 'object' && typeof env === 'object') {
            ...
            switch (commandFound) {
                ...
                */
                ...
                case 'OLD COMMAND SYSTEM +@123':
                    envInfo.results.value = await kill.reply(chatId, language(region, 'Cases', 'Standard', true, true, env.value), id);
                break;
                ...
                */
                ...
                /*
                    ...
                    Evite mexer nos parametros deste, pois é perigoso
                */
                case 'eval':
                    /* eslint-disable-next-line no-eval */
                    if (isOwner === true) return eval(env.value.body);
                break;
                ...
                */
                default:
                    if (isCmd === true) {
                        envInfo.results.value = await kill.reply(chatId, language(region, 'Cases', 'Test', true, true, env.value), id);
                    }
                break;
            }
        }
