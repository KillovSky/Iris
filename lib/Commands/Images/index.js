    ...
    try {
        ...
        if (typeof kill === 'object' && typeof env === 'object') {
            ...
            if (arks.includes('--help-dev') && isOwner === true) {
                ...
                /* Define a imagem */
                const imageLocated = await Indexer('images').search(sendingObject);
                ...
                if (argl.includes('-sticker') || command === 'getsticker') {
                    ...
                    /* Envia como imagem */
                } else envInfo.results.value = await kill.sendMessage(chatId, { image: { url: imageLocated.value }, caption: imageLocated.details }, { quoted: quoteThis });
            }
        }
