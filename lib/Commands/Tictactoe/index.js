                        ...
                        if (!Object.keys(inMemoryGame[chatId]).includes(gameCreator)) {
                            ...
                            if (inMemoryGame[chatId][gameCreator].currentStep !== user) {
                                ...
                                if (isVictory === 'draw') {
                                    ...
                                    /* Avisa o fim */
                                    await kill.sendMessage(chatId, { text: Indexer('sql').languages(region, 'Games', 'Victory', true, true, { gameend: 'K.O', winner: formattedWinner.replace(/@s.whatsapp.net/gi, '').value, looser: rivalPlayer.replace(/@s.whatsapp.net/gi, '') }), mentions: [inMemoryGame[chatId][gameCreator].playerOne, inMemoryGame[chatId][gameCreator].playerTwo] });
