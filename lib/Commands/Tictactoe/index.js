...
import tttagent from 'tictactoe-agent';
                        ...
                        if (!Object.keys(inMemoryGame[chatId]).includes(gameCreator)) {
                            ...
                            if (inMemoryGame[chatId][gameCreator].currentStep !== user) {
                                ...
                                if (isVictory === 'draw') {
                                    ...
                                    const formattedWinner = isVictory.replace(/@s.whatsapp.net|@lid/gi, '');
                                    ...
                                    /* Avisa o fim */
                                    await kill.sendMessage(chatId, { text: Indexer('sql').languages(region, 'Games', 'Victory', true, true, { gameend: 'K.O', winner: formattedWinner.replace(/@s.whatsapp.net|@lid/gi, ''), looser: rivalPlayer.replace(/@s.whatsapp.net|@lid/gi, '') }).value, mentions: [inMemoryGame[chatId][gameCreator].playerOne, inMemoryGame[chatId][gameCreator].playerTwo] });
