                ...
                switch (command) {
                    ...
                    case 'roll':
                        ...
                        await kill.sendMessage(chatId, {
                            image: { url: `${thisDir}/Cache/${finalType}.jpg` },
                    ...
                    case 'coroa':
                        ...
                        /* Envia a imagem do tipo com valor ganho/perdido */
                        await kill.sendMessage(chatId, {
                            image: { url: `${thisDir}/Cache/${flipValue}.png` },
                            caption: Indexer('sql').languages(region, 'Games', finalType, true, true, { finalType, ...gameChecker }).value,
                        }, reply);
                    ...
                    case 'roubar':
                        ...
                        if (lvpc <= stealChance) {
                            /* Avisa que deu certo */
                            envInfo.results.value = await kill.sendMessage(chatId, { text: Indexer('sql').languages(region, 'Games', 'winSteal', true, true, { sorryPeople: sorryPeople.replace(/@s.whatsapp.net|@lid/gi, ''), stealQuantity, stealMatterie }).value, mentions: [user, sorryPeople] }, reply);
                            ...
                            envInfo.results.value = await kill.sendMessage(chatId, { text: Indexer('sql').languages(region, 'Games', 'lostSteal', true, true, { payCops, paymentCops, victim: `@${sorryPeople.replace(/@s.whatsapp.net|@lid/gi, '')}` }).value, mentions: [user, sorryPeople] }, reply);
