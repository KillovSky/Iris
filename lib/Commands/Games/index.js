                ...
                switch (command) {
                    ...
                    case 'roubar':
                        ...
                        if (lvpc <= stealChance) {
                            ...
                            envInfo.results.value = await kill.sendMessage(chatId, { text: language(region, 'Games', 'lostSteal', true, true, { payCops, paymentCops, victim: `@${sorryPeople.replace(/@s.whatsapp.net/gi, '')}` }), mentions: [user, sorryPeople] }, { quoted: quoteThis });
