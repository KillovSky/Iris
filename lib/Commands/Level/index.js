    ...
    try {
        ...
        if (typeof kill === 'object' && typeof env === 'object') {
            ...
            if (arks.includes('--help-dev') && isOwner === true) {
                ...
                /* Define as menções */
                const mentionedPlayers = mentionedJidList.filter((j) => groupMembersId.includes(j) && j !== irisNumber && j !== user);
                ...
                if (arks.includes('-text')) {
                    ...
                    envInfo.results.value = await kill.sendMessage(chatId, { text: dialogueLvL }, { quoted: quoteThis });
                    ...
                    /* Envia */
                    await kill.sendMessage(chatId, { image: cardLeveling.value, caption: dialogueLvL, mentions: [user] }, { quoted: quoteThis });
                }
            }
        }
