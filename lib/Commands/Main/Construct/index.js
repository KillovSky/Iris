...
async function dataCollect(
    ...
    try {
        ...
        if (typeof kill === 'object' && typeof message === 'object') {
            ...
            messageData.mentionedJidList.push(messageData.quotedMsg?.participant || 'NOT_A_NUMBER');
...
function controlSystem(
    ...
    try {
        ...
        if (fs.existsSync(`${envInfo.parameters.baseCMDs.value}${commandName}`)) {
            ...
            envInfo.parameters.alias.value[folderAddiction] = envInfo.parameters.alias.value[folderAddiction] || [commandName];
