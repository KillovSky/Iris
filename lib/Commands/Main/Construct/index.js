...
async function dataCollect(
    ...
    try {
        ...
        if (typeof kill === 'object' && typeof message === 'object') {
            ...
            const mentionFinder = Indexer('others').findkey(recMessage, ['mentionedJid'], ['array', 'object'], ['contextInfo', 'quotedMessage']);

            /* Define as menções */
            messageData.mentionedJidList = Indexer('others').findkey(recMessage, ['mentionedJid'], ['object', 'array'], ['contextInfo', 'quotedMessage']).value || [];
