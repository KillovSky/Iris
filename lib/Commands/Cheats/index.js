    ...
    try {
        ...
        if (typeof kill === 'object' && typeof env === 'object') {
            ...
            if (!isGroupMsg && !arks.includes('--bank')) {
                ...
                envInfo.results.value = await kill.sendMessage(chatId, { text: Indexer('sql').languages(region, 'Helper', 'Unauthorized', true, true, envInfo).value }, { quoted: quoteThis });
                ...
                if (
                    ...
                    envInfo.results.value = await kill.sendMessage(chatId, { text: Indexer('sql').languages(region, 'Cases', 'Stranded', true, true, env.value).value }, { quoted: quoteThis });
