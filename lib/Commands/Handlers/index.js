            ...
            if ((conditions && type !== 'none') || (conditions2 && type !== 'none')) {
                ...
                if (arks.includes('--help') || type === 'handlers') {
                    ...
                    if (functions[type]?.enable === enaDis) {
                        ...
                        Indexer('sql').update(sqlType, user, chatId, type, { enable: enaDis });
                    ...
                    if (['vips', 'mods', 'blacklist', 'prefix', 'whitelist', 'antifake'].includes(type) && argl[0] !== '-text' && type !== 'antispam') {
                        ...
                        /* Sistemas de texto */
                    } else if (['goodbye', 'promote', 'demote', 'welcome', 'blacklist', 'antifake', 'language'].includes(type) && argl[0] === '-text' && type !== 'antispam') {
                        /* Define uma RegExp */
