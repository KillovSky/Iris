    ...
    try {
        ...
        if (typeof kill === 'object' && typeof env === 'object') {
            ...
            if (arks.includes('--help-dev') && isOwner === true) {
                ...
                /* Envia eles */
                envInfo.results.value = await kill.sendMessage(chatId, { image: { url: objectReplacer.thumb }, caption: Indexer('sql').languages(region, 'Helper', 'Nasa', true, true, objectReplacer).value }, { quoted: quoteThis });
            }
        }
