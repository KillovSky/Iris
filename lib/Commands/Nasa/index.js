        ...
        if (typeof kill === 'object' && typeof env === 'object') {
            ...
            if (arks.includes('--help-dev') && isOwner === true) {
                ...
                const objectReplacer = {
                    ...
                    url: NASA_INFO.nasa.url || NASA_INFO.nasa.hdurl || NASA_INFO.nasa.thumbnail_url || NASA_INFO.best_image,
                    type: NASA_INFO.nasa.media_type || 'N/A',
                    thumb: NASA_INFO.best_image || 'N/A',
