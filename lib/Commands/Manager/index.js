            ...
            if (arks.includes('--help-dev') && isOwner === true) {
                ...
                switch (command) {
                    ...
                    case 'remove':
                        ...
                        mentionsDo = mentionsDo.filter((j) => groupMembersId.includes(j) && !groupAdmins.includes(j) && j !== irisNumber && j !== user && !config.owner.value.includes(j));
                    ...
                    case 'undoadm':
                        ...
                        mentionsDo = mentionedJidList.filter((j) => groupAdmins.includes(j) && j !== groupCreator && !config.owner.value.includes(j) && j !== user);
                    ...
                    case 'unkick':
                        ...
                        if (config.allowAddParticipants.value === true) {
                            ...
                            mentionsDo = mentionedJidList.filter((j) => !groupMembersId.includes(j));

                            /* Define se tem um body maior que 7 números/letras e a let que vai armazenar o resultado */
                            let bodyNumbers = '';
